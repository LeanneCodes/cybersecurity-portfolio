...
const ProjectCard = ({ image, title, desc, children }) => {
  return (
    <div className='flex justify-center'>
      <div className='flex flex-col border-2 rounded-lg w-[424px] h-fit bg-mediumGrey'>
        {image && (
        ...
        <div className='flex flex-col justify-around items-start rounded-b-lg bg-mediumGrey space-y-4 p-4'>
